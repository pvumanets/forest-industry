...
- Установлены **Docker Desktop** (или Docker Engine + Compose v2) и **Node.js 20+**, **pnpm** (`corepack enable` или `npm i -g pnpm`).
...
- Доступ владельца к **VPS** по SSH; параметры из [`development-plan-v1.md`](./development-plan-v1.md) §3 (**2 vCPU, 2 GB RAM**; IP **`66.151.34.138`** — не секрет для закрытого репо; при публикации репо — ротация и вычистка из docs по плану).
...
- IP **`66.151.34.138`** в документах — осознанный риск для **приватного** репо ([`development-plan-v1.md`](./development-plan-v1.md) §3.1).
